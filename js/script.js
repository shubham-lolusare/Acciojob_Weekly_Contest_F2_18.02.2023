  ...
  temp.forEach((emp) => {
    ...
    Object.values(emp).forEach((text) => {
      ...
      if (text == "Not Returned") {
        ...
        cell.innerHTML =
          '<div class="lastCell"><div class="text">Not Returned</div><div class="icon"><button type="button" onclick="statusEdit(event)" id="checked"><span class="material-symbols-outlined"> edit </span></button></div></div>';
      }
    });
